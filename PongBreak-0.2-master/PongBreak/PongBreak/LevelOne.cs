...
namespace PongBreak
{
    public class LevelOne : CCLayer
    {
        ...
        List<BlueBrick> bricksRow1;//array of brick entities. a row of bricks
        List<BlueBrick> bricksRow2;
        List<BlueBrick> bricksRow3;
        ...
        void CreateBricks(List<CCRect> rects, List<BlueBrick> bricksList, int amount, float x, float y)
        {
            
          for (int i = 0; i < amount; i++)
          {
                bricksList.Add(new BlueBrick());
        ...
        {
            var texture = new CCTexture2D("ice_Background.png");
        ...
        protected override void AddedToScene()
        {
            ...
            bricksRow1 = new List<BlueBrick>();
            bricksRow2 = new List<BlueBrick>();
            bricksRow3 = new List<BlueBrick>();
            bricksRow4 = new List<SilverBrick>();
            CreateBricks(bricksBoundingBoxRow1, bricksRow1, 9, 155, 2000);
            CreateBricks(bricksBoundingBoxRow2, bricksRow2, 9, 155, 1920);
        ...
        //method handles what occurs when a ball hits a silver brick
        ...
        //handlepaddlecollisions handles what occurs when the ball intersects the paddle
        ...
        //gameOver method occurs when the player runs out of lives, allowing them to return to Level Select
        ...
        public static CCScene LvlOneScene(CCWindow mainWindow)
        {
            var scene = new CCScene(mainWindow);
            var layer = new LevelOne();
